...
result_2 = Result(team_3, 148.04, team_4, 99.22)
result_repo.save(result_2)
result_2.determine_result()

result_3 = Result(team_3, 132.14, team_1, 88.02)
result_repo.save(result_3)
result_3.determine_result()

result_4 = Result(team_4, 167.86, team_2, 99.89)
result_repo.save(result_4)
result_4.determine_result()

result_5 = Result(team_4, 132.76, team_1, 111.66)
result_repo.save(result_5)
result_5.determine_result()

result_6 = Result(team_2, 125.44, team_3, 81.67)
result_repo.save(result_6)
result_6.determine_result()
